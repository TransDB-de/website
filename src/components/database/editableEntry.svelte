<script lang="ts">
	...
	const { subjectMapping, typeMapping, offerMapping, attributeMapping, accessibleMapping } =
		t("entryMapping");
	...
	function filterWithMapping(
		fields: string[],
		type: string,
		mapping: typeof offerMapping | typeof attributeMapping
	) {
...
<div class="editable-entry">
	<div class="auto-grid">
			...
			{#if noGeoData}
				<span class="warn">
					...
					{#if edit && geoNotRefetched}
						<Button light title={t("mouseOverTexts.reloadGeo")} on:click={refetchGeo}
		...
		<div class="sub-grid">
			<EditableRadioList
				...
				mapping={offerMapping[_entry.type]}
				{edit}
			/>
			<EditableRadioList
				label="Attribute"
				bind:value={_entry.meta.attributes}
				mapping={attributeMapping[_entry.type]}
				{edit}
			/>
		</div>
		...
		<div class="sub-grid">
			...
			{#if subjectMapping[_entry.type]}
				<EditableSelectField
					...
					mapping={subjectMapping[_entry.type]}
					{edit}
				/>
			{/if}
	...
	<div class="controls">
		{#if edit}
			<Button light iconOnly on:click={saveChanges} title={t("mouseOverTexts.saveChanges")}>
				<SaveIcon />
			</Button>
			<Button light iconOnly on:click={cancelEdit} title={t("mouseOverTexts.discardChanges")}>
				<XIcon />
			</Button>
			<DeleteEntryButton on:remove {entry} />
		{:else}
			<Button light iconOnly on:click={editEntry} title={t("mouseOverTexts.editEntry")}>
				<EditIcon />
			</Button>
			<Button light iconOnly on:click={copyLink} title={t("mouseOverTexts.copyLink")}>
				<LinkIcon />
			</Button>
		{/if}
	</div>
