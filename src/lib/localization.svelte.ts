 ...
 */
export function initLocalization(data: { preferredLang?: string }) {
	...
	translation = (availableTranslations as Record<string, any>)[currentLocale];
}

export function setLocale(newLocale: string) {
	document.cookie = `preferred-lang=${newLocale}; SameSite=Strict; Secure`;
 ...
 */
export function t(key: MappingKey | keyof TranslationMapping) {
